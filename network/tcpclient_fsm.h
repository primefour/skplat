...
class TcpClientFSM {
  ...
  public:
    ...
    virtual void PreSelect(SocketSelect& _sel);
    virtual void AfterSelect(SocketSelect& _sel);
  ...
  protected:
    virtual void PreConnectSelect(SocketSelect& _sel);
    virtual void AfterConnectSelect(const SocketSelect& _sel);
    virtual void PreReadWriteSelect(SocketSelect& _sel);
    virtual void AfterReadWriteSelect(const SocketSelect& _sel);
